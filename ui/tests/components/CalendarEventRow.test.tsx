...
describe("CalendarEventRow", () => {
  it("shows beat symbol when outcome is beat", () => {
    ...
    render(<CalendarEventRow event={event} isPast={false} />);
  ...
  it("renders event name", () => {
    render(<CalendarEventRow event={makeEvent()} isPast={false} />);
  ...
  it("past rows render with reduced opacity", () => {
    render(<CalendarEventRow event={makeEvent()} isPast={true} />);
  ...
  it("does not render promoted badge for non-promoted events", () => {
    render(<CalendarEventRow event={makeEvent({ promoted: false })} isPast={false} />);
