...
describe("WeekSummaryCell — ISO week label", () => {
  it("renders 'Wk' when no weekDate is provided", () => {
    render(<WeekSummaryCell pnl={0} tradeCount={0} wins={0} losses={0} />);
    expect(screen.getByText("Wk")).toBeInTheDocument();
  });

  it("renders W16 for Monday 2026-04-13 (mid-April)", () => {
    render(
      <WeekSummaryCell pnl={0} tradeCount={0} wins={0} losses={0} weekDate="2026-04-13" />
    );
  ...
  it("renders W1 for 2026-01-01 (Thursday — belongs to week 1 of 2026)", () => {
    render(
      <WeekSummaryCell pnl={0} tradeCount={0} wins={0} losses={0} weekDate="2026-01-01" />
    );
  ...
  it("renders W53 for 2026-12-31 (Thursday — last week of 2026)", () => {
    render(
      <WeekSummaryCell pnl={0} tradeCount={0} wins={0} losses={0} weekDate="2026-12-31" />
    );
  ...
  it("never renders W0 or W54 for any boundary date", () => {
    ...
    for (const date of boundaryCases) {
      const { unmount } = render(
        <WeekSummaryCell pnl={0} tradeCount={0} wins={0} losses={0} weekDate={date} />
      );
  ...
  it("renders W1 for 2025-12-29 (Monday — ISO week belongs to 2026 week 1)", () => {
    ...
    render(
      <WeekSummaryCell pnl={0} tradeCount={0} wins={0} losses={0} weekDate="2025-12-29" />
    );
    expect(screen.getByText("W1")).toBeInTheDocument();
  });
});
...
describe("WeekSummaryCell — trade summary display", () => {
  it("shows no P&L when tradeCount is 0", () => {
    render(
      <WeekSummaryCell pnl={150} tradeCount={0} wins={0} losses={0} weekDate="2026-04-13" />
    );
  ...
  it("shows positive P&L with + prefix when tradeCount > 0", () => {
    render(
      <WeekSummaryCell pnl={250} tradeCount={3} wins={2} losses={1} weekDate="2026-04-13" />
    );
  ...
  it("shows negative P&L with - prefix", () => {
    render(
      <WeekSummaryCell pnl={-100} tradeCount={2} wins={0} losses={2} weekDate="2026-04-13" />
    );
  ...
  it("shows wins and losses record", () => {
    render(
      <WeekSummaryCell pnl={50} tradeCount={3} wins={2} losses={1} weekDate="2026-04-13" />
    );
