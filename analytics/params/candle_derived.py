...
Also exports ``_find_signal_bar``, ``_atr_pips_at_bar``, and ``_volume_at_bar``
helpers for use by other param modules (e.g. ``analytics.params.volume``).
"""
...
# ---------------------------------------------------------------------------
# Shared helpers (imported by fvg_impulse.py, nova_candle.py, volume.py)
# ---------------------------------------------------------------------------
